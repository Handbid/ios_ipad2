...
enum DashboardGoal: CaseIterable, Hashable {
	...
	var title: LocalizedStringKey {
		switch self {
		case .goal: .init("dashboard_label_overallGoal")
		case .bidders: .init("dashboard_label_bidders")
		case .guests: .init("dashboard_label_guests")
		case .performance: .init("dashboard_label_auctionPerformance")
		}
	}
