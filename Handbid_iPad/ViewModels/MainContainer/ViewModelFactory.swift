...
enum ViewModelFactory {
	static func createAllViewModelsForMainContainer() -> (AuctionViewModel, PaddleViewModel, MyBidsViewModel, ManagerViewModel, LogOutViewModel, SearchItemViewModel) {
		...
		return (AuctionViewModel(dataService: dataService),
		        ...
		        SearchItemViewModel(dataService: dataService))
	}
}
